...
const homepageContentFields = [
  { group: "Homepage Hero", key: "hero_heading", label: "Hero Headline", fallback: "Catering Made Easy", required: true },
  ...
  { key: "minimum_order", label: "Minimum Order Text", fallback: "15-person minimum" },
