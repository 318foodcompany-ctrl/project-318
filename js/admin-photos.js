...
const photos = [
  ...
  },
  {
    ...
    title: "About Hero",
    file: "about-hero.jpg",
    description: "Top banner image for the About page."
  },
  {
    id: "about",
    title: "About Section",
    file: "about.jpg",
    description: "Main story image on the About page and homepage About section."
  },
  {
    id: "corporateHero",
    title: "Corporate Hero",
    file: "corporate-hero.jpg",
    description: "Top banner image for the Corporate Catering page."
  },
  {
    id: "corporateSection",
    title: "Corporate Section",
    file: "corporate-section.jpg",
    description: "Main image beside the Corporate Catering section text."
  },
  {
    id: "logo",
    title: "Logo",
    file: "logo.jpg",
    description: "Website logo used in page navigation.",
    previewFit: "contain"
  },
  {
    id: "favicon",
    title: "Favicon",
    file: "favicon.png",
    description: "Small browser tab icon. PNG, ICO, or SVG files work best.",
  ...
  },
  {
    ...
    file: "catering.jpg",
    description: "Catering package image."
  },
  {
    id: "gallery1",
...
async function loadImages() {
  photos.forEach((photo) => {
    ...
    if (preview) {
      preview.src = photoUrl(photo.file);
    }
  });
}
